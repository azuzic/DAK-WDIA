...
**Posljednje ažurirano:** 20. listopada 2025.
...
- [[1] HTML Osnove](#1-html-osnove)
    ...
    - [2. HTML](#2-html)
    - [3. Osnovni HTML elementi](#3-osnovni-html-elementi)
        - [Tekstualni elementi: paragrafi, naslovi](#tekstualni-elementi-paragrafi-naslovi)
            ...
            - [Zašto nam treba struktura?](#zašto-nam-treba-struktura)
            - [Zašto nam treba semantika?](#zašto-nam-treba-semantika)
        - [Naglašavanje i važnost u HTML-u](#naglašavanje-i-važnost-u-html-u)
            - [Naglašavanje (*emphasis*)](#naglašavanje-emphasis)
            - [Ugniježđivanje elemenata](#ugniježđivanje-elemenata)
            - [Snažan naglasak (*strong importance*)](#snažan-naglasak-strong-importance)
            - [Kombiniranje naglaska i važnosti](#kombiniranje-naglaska-i-važnosti)
            - [Mark](#mark)
        ...
        - [Liste](#liste)
            ...
            - [Ugniježđivanje lista](#ugniježđivanje-lista)
        ...
        - [Ostali tekstualni elementi](#ostali-tekstualni-elementi)
            ...
            - [Predstavljanje računalnog koda](#predstavljanje-računalnog-koda)
        - [Strukturiranje dokumenata](#strukturiranje-dokumenata)
            - [Osnovni dijelovi dokumenta](#osnovni-dijelovi-dokumenta)
            - [Ne-semantički omotači](#ne-semantički-omotači)
        ...
        - [Stvaranje poveznica](#stvaranje-poveznica)
            - [Što je hiperveza?](#što-je-hiperveza)
        ...
        - [HTML slike](#html-slike)
            ...
            - [Širina i visina (`width` i `height`)](#širina-i-visina-width-i-height)
...
#### Predstavljanje računalnog koda

Postoji nekoliko HTML elemenata za označavanje računalnog koda:

- `<code>`: za označavanje općih dijelova koda
- `<pre>`: zadržava razmake i prijelome linija (*blokovi koda*) - ako koristite uvlačenje ili više praznih znakova, preglednici ih inače ignoriraju. Ako tekst stavite unutar `<pre></pre>` oznaka, razmaci će se prikazati točno onako kako su u uređivaču
...
<div style="width: fit-content; display: flex; flex-direction: column;">
    ...
    <br/>
    <p style="margin-top: -16px; width: 100%; text-align: center;"><i>Predstavljanje računalnog koda</i></p>
</div>
...
> **Upozorenje:** `<div>` elementi su vrlo praktični, pa ih je lako pretjerano koristiti. Budući da nemaju semantičko značenje, mogu nepotrebno zakomplicirati vaš HTML kod. Koristite ih samo kada ne postoji bolja semantička alternativa i trudite se smanjiti njihovu uporabu na minimum.
...
- **`<br>` - element za prijelom retka**
  ...
  <p>
    ...
    pa mu se kod baš i nije dobro čitao.
  </p>
  ```
  ...
  Bez `<br>` oznaka, cijeli bi se tekst prikazao u jednom dugom retku (*jer HTML ignorira većinu praznina u kodu*).
...
#### Širina i visina (`width` i `height`)
Možete koristiti `width` i `height` da odredite dimenzije slike u pikselima:

```html
<img src="cat.jpg" alt="Tall Cat" width="200" height="400"/>
<img src="cat.jpg" alt="Wide Cat" width="400" height="200"/>
```
